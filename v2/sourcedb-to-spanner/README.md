...
#### Required Parameters
* **sourceConfigURL** (Configuration to connect to the source database): Can be the JDBC URL or the location of the sharding config. (Example: jdbc:mysql://10.10.10.10:3306/testdb or gs://test1/mySqlShard.conf). Refer to src/main/scripts/create_simple_shard_config.bash for steps to generate a mySqlShard configuration.
