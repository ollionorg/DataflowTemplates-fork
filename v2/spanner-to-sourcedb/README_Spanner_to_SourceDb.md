...
* **sourceShardsFilePath** : Path to GCS file containing connection profile info for source mySqlShards.
...
* **maxShardConnections** : This will come from mySqlShard file eventually. Defaults to: 10000.
