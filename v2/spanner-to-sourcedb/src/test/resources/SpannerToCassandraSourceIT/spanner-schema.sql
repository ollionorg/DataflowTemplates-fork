...
CREATE TABLE IF NOT EXISTS emptystringjsontable (
    ...
    varchar_list_col ARRAY<STRING(20)>,
    inet_list_col ARRAY<STRING(20)>,
    bigint_list_col ARRAY<INT64>,
    tinyint_varint_map_col JSON,
    text_set_col ARRAY<STRING(20)>,
    double_set_col ARRAY<FLOAT64>,
    time_list_col ARRAY<TIMESTAMP>,
    frozen_ascii_list_col ARRAY<STRING(20)>,
    int_list_col ARRAY<INT64>,
    ascii_list_col ARRAY<STRING(20)>,
    ...
    timeuuid_list_col ARRAY<STRING(20)>,
    date_list_col ARRAY<DATE>,
    uuid_set_col ARRAY<STRING(20)>,
    ...
    inet_set_col ARRAY<STRING(20)>,
    timeuuid_varchar_map_col JSON,
    duration_list_col ARRAY<STRING(20)>,
    frozen_ascii_set_col ARRAY<STRING(20)>
) PRIMARY KEY(varchar_column);
